# Personnal-Training-Data-analytics-projects

Il s'agit d'un ensemble de projets que je réalise dans le but de m'améliorer en tant que data Specialist. A la différence des autres projets, les thèmes abordés ici, sont inspirés de projets déjà réalisés, ce sont des études de cas que l'ont rencontre généralement dans l'industrie de la data. Je les explore à ma manière, je documente mon approche et j'y insère mes propres résultats.
